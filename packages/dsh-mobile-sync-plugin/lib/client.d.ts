...
interface GoalSnapshot extends GoalRef$1 {
...
declare module '@deepseek-ai/dsh-typert-protocol' {
  interface TypertRemoteNamespace$676f616c73 {
    ...
    complete: (agentId: SessionId, ref: GoalRef$1) => Promise<RemoteResult<GoalView>>;
    create: (agentId: SessionId, request: CreateGoalRequest) => Promise<RemoteResult<CreateGoalResult>>;
    edit: (agentId: SessionId, ref: GoalRef$1, request: EditGoalRequest) => Promise<RemoteResult<GoalView>>;
    pause: (agentId: SessionId, ref: GoalRef$1) => Promise<RemoteResult<GoalView>>;
    resume: (agentId: SessionId, ref: GoalRef$1) => Promise<RemoteResult<GoalView>>;
  }
  interface TypertRemoteMap {
    'goals/clear': (agentId: SessionId, ref: GoalRef$1) => Promise<RemoteResult<GoalRef$1>>;
    'goals/complete': (agentId: SessionId, ref: GoalRef$1) => Promise<RemoteResult<GoalView>>;
    'goals/create': (agentId: SessionId, request: CreateGoalRequest) => Promise<RemoteResult<CreateGoalResult>>;
    'goals/edit': (agentId: SessionId, ref: GoalRef$1, request: EditGoalRequest) => Promise<RemoteResult<GoalView>>;
    'goals/pause': (agentId: SessionId, ref: GoalRef$1) => Promise<RemoteResult<GoalView>>;
    'goals/resume': (agentId: SessionId, ref: GoalRef$1) => Promise<RemoteResult<GoalView>>;
  }
  interface TypertRemoteNamespaceMap {
    'goals': TypertRemoteNamespace$676f616c73;
  }
  interface TypertRemoteScopeMap {
    'agent:goals/clear': (ref: GoalRef$1) => Promise<RemoteResult<GoalRef$1>>;
    'agent:goals/complete': (ref: GoalRef$1) => Promise<RemoteResult<GoalView>>;
    'agent:goals/create': (request: CreateGoalRequest) => Promise<RemoteResult<CreateGoalResult>>;
    'agent:goals/edit': (ref: GoalRef$1, request: EditGoalRequest) => Promise<RemoteResult<GoalView>>;
    'agent:goals/pause': (ref: GoalRef$1) => Promise<RemoteResult<GoalView>>;
    'agent:goals/resume': (ref: GoalRef$1) => Promise<RemoteResult<GoalView>>;
  }
}
//#endregion
